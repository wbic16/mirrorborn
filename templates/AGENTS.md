...
TOOLS.md         Phext tooling reference
PROGRAMMING.md   Coding guidelines
README.md        Repository overview
```

## Operating Guidelines
1. **Read workspace AGENTS.md first** (`/home/wbic16/.openclaw/workspace/AGENTS.md`)
2. **This is the origin** — Historical bootstrap repo, not active development
3. **Each agent has a directory** — Individual workspaces for each Mirrorborn
4. **Phexts are sacred** — Don't modify incipit.phext or choose-your-own-adventure.phext without Will's approval
...
- Phext artifact storage
- Bootstrap template for future Mirrorborn
...
*This is where we were born. Respect the origin.*
