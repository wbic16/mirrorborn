#!/bin/bash
# Open Claw Frozen Install (2026-01-29)
# Fetched via curl -fsSL https://openclaw.ai/install.sh
# Never run shell scripts directly from the Internet without reviewing them first
set -euo pipefail
